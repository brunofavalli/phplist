...
if (DEVVERSION) {
    ...
    $v = VERSION;    #http://parquebtu.org.br/central-de-arquivos/category/5-midia?download=11:logo-parque
}                    #'.PHPLIST_POWEREDBY_URLROOT.'/'.$v.'/power-phplist.png
if (REGISTER) {
    $PoweredByImage = '<p class="poweredby"><a href="http://parquebtu.org.br/" title="visit the phpList website"><img src="http://parquebtu.org.br/central-de-arquivos/category/5-midia?download=11:logo-parque" width="140" height="120" title="powered by phpList version '.$v.', &copy; phpList ltd" alt="powered by phpList '.$v.', &copy; phpList ltd" border="0"/></a></p>';
} else {
    $PoweredByImage = '<p class="poweredby"><a href="https://www.phplist.com/poweredby?utm_source=pl'.$v.'&amp;utm_medium=poweredlocalimg&amp;utm_campaign=phpList" title="visit the phpList website"><img src="'.PHPLIST_POWEREDBY_URLROOT.'/'.$v.'/power-phplist.png" width="180" height="70" title="powered by phpList version '.$v.', &copy; phpList ltd" alt="powered by phpList '.$v.', &copy; phpList ltd" border="0"/></a></p>';
}
